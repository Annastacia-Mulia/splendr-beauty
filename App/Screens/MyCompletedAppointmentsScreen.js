...
const MyCompletedAppointmentsScreen = ({ navigation }) => {
  ...
  const handleSubmit = async (appointmentId) => {
    ...
    const updatedAppointments = completedAppointments.filter(appointment => appointment.id !== appointmentId);
    ...
    <View style={styles.appointmentItem}>
      <View style={styles.labelValueContainer}>
        ...
        <Rating
          ...
          imageSize={16}
          showRating={false}
          onFinishRating={(rating) => handleRatingCompleted(rating, item.id, 'beautician')}
          style={styles.rating}
        />
      </View>
      ...
      <View style={styles.labelValueContainer}>
        ...
        <Rating
          ...
          imageSize={16}
          showRating={false}
          onFinishRating={(rating) => handleRatingCompleted(rating, item.id, 'business')}
          style={styles.rating}
        />
      </View>
      ...
      <View style={styles.labelValueContainer}>
        ...
        <Rating
          ...
          imageSize={16}
          showRating={false}
          onFinishRating={(rating) => handleRatingCompleted(rating, item.id, 'service')}
          style={styles.rating}
        />
      </View>
