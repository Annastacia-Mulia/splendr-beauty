...
import LogoutConfirmation from "../../../splendr-beauty/App/Screens/LogoutConfirmation"; // Import the modal component
...
const styles = StyleSheet.create({
  ...
  boxButton: {
    ...
    height: width * 0.2, // Make the height equal to the width for square buttons
    backgroundColor: "#fff",
    padding: 10,
    borderRadius: 10,
    marginVertical: 10,
